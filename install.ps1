...
$SCOOP_PACKAGE_REPO = 'https://ghproxy.085404.xyz/https://github.com/ScoopInstaller/Scoop/archive/master.zip'
$SCOOP_MAIN_BUCKET_REPO = 'https://ghproxy.085404.xyz/https://github.com/ScoopInstaller/Main/archive/master.zip'
